#!/bin/bash
require_env DEPLOY_SHA MONITORING_BIND_IP MONITORING_VOLUME_PREFIX GRAFANA_ADMIN_PASSWORD DISCORD_WEBHOOK_URL \
...
export MONITORING_PROMETHEUS_CONFIG="${STATE_DIR}/monitoring/${DEPLOY_SHA}/prometheus.json"
