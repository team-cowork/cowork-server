...
import com.cowork.gateway.security.jwt.JwtAuthenticationSupport
import com.cowork.gateway.security.jwt.JwtReactiveAuthenticationManager
import com.cowork.gateway.security.jwt.JwtServerAuthenticationConverter
import com.cowork.gateway.security.websocket.WsJwtServerAuthenticationConverter
import com.cowork.gateway.security.websocket.WsOriginFilter
        ...
        return http
            ...
            .authorizeExchange { exchanges ->
                exchanges
                    ...
                    .pathMatchers(HttpMethod.GET, "/health", "/health/**").permitAll()
