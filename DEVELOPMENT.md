...
Vert.x Reactive PostgreSQL Client를 사용합니다. 마이그레이션 파일은 없으며 스키마는 `src/main/resources/db/migration/`에서 관리합니다.
...
- 시크릿 경로: `secret/application`, `secret/cowork-{name}`
...
| cowork-project | 8089 (→8084) | Kotlin (Spring Boot) |
