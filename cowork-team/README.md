...
- MinIO presigned URL 기반 팀 아이콘 업로드·확정·교체·삭제
...
- Spring Kafka, Spring Cloud AWS S3(MinIO)
...
- MySQL, MinIO, Eureka, Config Server
...
| Config Server | 포트, MySQL URL, Kafka, Eureka, MinIO endpoint/region |
| Vault | MySQL 계정, MinIO access/secret key |
