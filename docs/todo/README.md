...
- reliability: [멤버십 projection의 compacted 키 계약 복구와 latch 자동 해제](./items/40-reliability/membership-projection-key-contract-recovery.md)

## 점검 스냅샷

- [20260907](./20260907_TODO.md) — 채팅 projection 계약·복구 경로 점검
