...
class TeamProjectController(
    private val reorderTeamProjectsService: ReorderTeamProjectsService,
) {
    ...
    fun reorderTeamProjects(
        ...
        reorderTeamProjectsService.reorderTeamProjects(userId, teamId, request.orderedProjectIds)
}
