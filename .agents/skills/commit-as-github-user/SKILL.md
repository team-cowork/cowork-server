...
2. Run the read-only resolver:
   ...
   ```bash
   python3 /absolute/path/to/this-skill/scripts/github_identity.py resolve GITHUB_LOGIN
   ```
...
3. Run the helper for **each** group, repeating any identity options used in resolution:
   ...
   ```bash
   python3 /absolute/path/to/this-skill/scripts/github_identity.py commit GITHUB_LOGIN \
